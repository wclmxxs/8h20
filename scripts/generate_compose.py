    ...
    if sol_enabled:
        service.extend(
            [
                ...
                '      LORA_MERGE_MODE: "${SOL_LORA_MERGE_MODE:-merge}"',
                '      SGLANG_DIFFUSION_LORA_BEFORE_FP8: "${SOL_LORA_BEFORE_FP8:-1}"',
    ...
    reporter_config = {
        ...
        "deployment": {
            ...
            "optimization_stack": {
                ...
                "lora_merge_mode": os.getenv("SOL_LORA_MERGE_MODE", "merge"),
                "lora_before_fp8": os.getenv("SOL_LORA_BEFORE_FP8", "1"),
                "cache_dit": {
